...
a = [6.56, 3.26, 6.72, 1.05]  # 4ф Альтман
...
for index, row in x_test.iterrows():
    params = [(row['1200 (2018)'] - row['1500 (2018)']) / row['1600 (2018)'],
              row['1370 (2018)'] / row['1600 (2018)'],
              row['2300 (2018)'] / row['1600 (2018)'],
              row['1300 (2018)'] / (row['1400 (2018)'] + row['1500 (2018)'])]
